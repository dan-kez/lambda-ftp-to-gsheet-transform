    ...
    account_seed_data = {
        ...
        "001940": [
            ...
            AccountColumn(
                "001940",
                "HAWB Issuer Code",
                xpath_query="/CUSTOMS_ENTRY_FILE/ENTRY/MANIFEST/HOUSE_ISSUER_CODE",
                relative_to_xpath=account_001940_relative_to_xpath,
                order=5,
            ),
            AccountColumn(
                "001940",
                "HAWB Number",
                xpath_query="/CUSTOMS_ENTRY_FILE/ENTRY/MANIFEST/HOUSE",
                relative_to_xpath=account_001940_relative_to_xpath,
                order=6,
            ),
            AccountColumn(
                "001940",
                "Filer Code",
                xpath_query="/CUSTOMS_ENTRY_FILE/ENTRY/FILER_CODE",
                relative_to_xpath=account_001940_relative_to_xpath,
                order=7,
            ),
            AccountColumn(
                "001940",
                "Entry #",
                xpath_query="/CUSTOMS_ENTRY_FILE/ENTRY/ENTRY_NO",
                relative_to_xpath=account_001940_relative_to_xpath,
                order=7,
            ),
            AccountColumn(
